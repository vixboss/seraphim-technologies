...
const SubscriptionListComponent = ({allSubscriptions}) => {
    const columns = [
        ...
        },
        {
            ...
            format: (value) => {
                if(!!value) {
                    return React.createElement("span",{style: {color: 'green'}}, "Subscribed");
                }
                else{
                    return React.createElement("span", {style: {color: 'red'}}, "Unsubscribed");
                }
            }
        }
    ...
    const subscriptionList = checkUndefined(allSubscriptions);

    const [rows, setRows] = useState(subscriptionList);
    ...
    const handleSearch = (event) => {
        ...
        setSearch(value);
        if(value !== ""){
            setRows(subscriptionList.filter((data) => {
